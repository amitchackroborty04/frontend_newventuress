    ...
    <div className={cn("flex flex-col gap-2 w-full", className)}>
      <motion.div>
        <motion.input
          ...
          className="w-full dark:bg-white dark:text-black   px-4 py-2 border  rounded-[8px] disabled:opacity-50 disabled:cursor-not-allowed outline-none ring-0 border-[#B0B0B0] dark:border-[#B0B0B0] h-[54px]"
