...
export default function AuctionMobileNav({ label, links, onClose }: DropdownProps) {
  ...
  return (
    <div className="">
      ...
      <button
        ...
        className="w-full flex items-center text-left rounded-lg px-6 py-2 text-[20px] font-normal text-black hover:bg-[#E6EEF6]"
      >
