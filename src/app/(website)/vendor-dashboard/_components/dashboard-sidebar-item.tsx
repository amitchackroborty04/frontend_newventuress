...
const DashboardSidebarItem = ({ item }: Props) => {
  ...
  return (
    <div className="relative pl-[18px] 2xl:pl-[38px]">
      ...
      <span className={`absolute top-[-48px] 2xl:top-[-48px] right-8 2xl:right-0 w-12 h-12 bg-transparent rounded-full shadow-[35px_35px_0_10px_#E6EEF6] ${isActive ? "block" : "hidden bg-[#E6EEF6] "}`}></span>
      <span className={`absolute bottom-[-48px]  right-8 2xl:right-0 w-12 h-12 bg-transparent rounded-full shadow-[35px_-35px_0_10px_#E6EEF6] ${isActive ? "block" : "hidden"}`}></span>
